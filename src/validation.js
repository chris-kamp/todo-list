...
function validateTodo(msg, {title, description, dueDate, priority, project, loaded}) {
    ...
    if(dueDate === false) {
        ...
        PubSub.publish(EventHub.topics.TODO_VALIDATED, {title, description, dueDate, priority, project, loaded});
    }
}
